...
class MINSTHelper:
    def __init__(self, data_path):
        self.train_images = self.loadTrainImages(data_path+'train-images.idx3-ubyte')
        self.train_labels = self.loadTrainLabels(data_path+'train-labels.idx1-ubyte')
        self.test_images = self.loadTrainImages(data_path+'t10k-images.idx3-ubyte')
        self.test_labels = self.loadTrainLabels(data_path+'t10k-labels.idx1-ubyte')
